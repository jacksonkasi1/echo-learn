 ...
 */
export const DEFAULT_CONCEPT_MASTERY: Omit<ConceptMastery, 'conceptId' | 'conceptLabel' | 'createdAt' | 'lastInteraction' | 'nextReviewDate'> = {
...
/**
 * Extended graph edge with learning semantics
 */
export interface LearningEdge {
  ...
  propagationWeight: number   // How much mastery propagates (0.0 - 1.0)
}
 ...
 */
export type QuestionType = 'definition' | 'application' | 'comparison' | 'analysis'
