...
import type { ScenarioContext, TestConfiguration } from "./test-config.js";
...
export interface TestQuestion {
  ...
  scenario?: ScenarioContext; // Scenario context for scenario-based questions
  isScenarioBased?: boolean; // Whether this is a scenario-based question
}
...
export interface TestSession {
  ...
  // Enhanced configuration from user input
  config?: TestConfiguration; // Full user configuration
