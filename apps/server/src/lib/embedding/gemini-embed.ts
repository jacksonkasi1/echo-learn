// ** import types
import type { TextChunk, ChunkWithEmbedding, EmbeddingResult, BatchEmbeddingResult } from '@repo/shared'
...
export async function generateEmbeddingsForChunks(
    ...
    try {
      ...
      for (const chunk of batch) {
        try {
          ...
          logger.error(`Failed to generate embedding for chunk ${chunk.id}`, retryError)
  ...
  logger.info(`Generated ${results.length}/${chunks.length} embeddings in ${elapsedMs}ms`)
